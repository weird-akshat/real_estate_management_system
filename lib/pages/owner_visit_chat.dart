...
class OwnerVisitChat extends StatefulWidget {
  final String buyerId;
  final int propertyId;
  const OwnerVisitChat(
      {super.key, required this.buyerId, required this.propertyId});

  @override
  State<OwnerVisitChat> createState() => _NegotiationChatState();
}

class _NegotiationChatState extends State<OwnerVisitChat> {
